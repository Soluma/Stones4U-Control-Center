...
// (docs/QUOTE-DELIVERY-DATE-MANUAL-ACTIVATION.md). No automatic handoff
// creation, no OfferteApp integration, no mail — a staff member finds a
// Shopify Draft Order and deliberately creates a public delivery-date
// link for it.
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-tertiary">
          Maak een publieke link waarmee een klant een gewenste leverdatum kan opgeven voor een Shopify-
